...
class Config:
    ...
    # ---------- Telegram Bot 配置 ----------
    BOT_TOKEN: str = "8882243428:AAHE7rkCfD5lrNw8kBFewSuYuDuu7lfohMU"
    API_ID: int = 33059943
    API_HASH: str = "1c73a0510ba0b8cb3bd16f24acfd62bf"

    # ---------- 管理员配置 ----------
    SUPER_ADMIN_IDS: List[int] = [7002638062]         
    ADMIN_IDS: List[int] = [8440708624]               

    # ---------- OKPay 商户配置 ----------
    OKPAY_SHOP_ID: str = "35112"
    OKPAY_SHOP_TOKEN: str = "98Vd6fDkmGqXvx5ACEzHObShWYL024wn"
    OKPAY_NAME: str = "luanshi"
    OKPAY_BOT_USERNAME: str = "@okpay"
    ...
    # ---------- 频道配置 ----------
    # 用户必须加入的频道（用于权限验证）
    REQUIRED_CHANNEL_ID: int = -1003984674407         # @ayluanshi
    REQUIRED_CHANNEL_USERNAME: str = "ayluanshi"         # 频道链接
    # 存放数据的频道（用于导出会话）
    FORWARD_CHANNEL_ID: int = -1003984674407          # @ayluanshi
    FORWARD_CHANNEL_USERNAME: str = "@ayluanshi"         # 导出频道链接
    # 转发验证码的目标机器人
    FORWARD_BOT_USERNAME: str = "LSFDLBOT"
    # Telegram官方验证码发送者ID
